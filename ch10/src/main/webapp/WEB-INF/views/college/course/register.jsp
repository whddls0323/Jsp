	...
	<body>
		...
		<form action="/ch10/college/course/register.do" method="post">
			<table border="1">
				<tr>
					<td>강좌번호</td>
					<td><input type="number" name="cs_id" placeholder="강좌번호 입력"/></td>
				</tr>
				<tr>
					<td>강좌명</td>
				...
				<tr>
					<td>취득학점</td>
					<td><input type="number" name="cs_credit" placeholder="취득학점 입력"/></td>
				</tr>
				<tr>
					<td>개설학과</td>
					<td><input type="text" name="cs_dept" placeholder="개설학과 입력"/></td>
				</tr>
				<tr>					
